...
const SignupContainer: Component = () => {
    return (
        <div class="max-w-7xl mx-auto pb-10 pt-20 px-4 sm:px-6 lg:px-8 lg:flex lg:items-center lg:justify-between">
            <h2 class="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                <span class="block text-white">Ready to dive in?</span>
                <span class="text-blue-500">Get a free server on us.</span>
            </h2>
